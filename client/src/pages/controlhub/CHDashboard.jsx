...
export default function CHDashboard() {
  ...
  return (
    <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <div>
        <h1 style={{ fontSize: '1.75rem', fontWeight: '700', color: 'var(--text)' }}>ControlHub Super-Admin Dashboard</h1>
        <p style={{ color: 'var(--text-2)', fontSize: '0.9rem', marginTop: '4px' }}>Multi-Tenant Pharmacy Platform Supervision & Onboarding</p>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
        <div className="stat-card">
          <span style={{ fontSize: '0.85rem', color: 'var(--text-2)' }}>Total Pharmacy Sites</span>
          <h2 style={{ fontSize: '1.6rem', color: '#60a5fa', marginTop: '6px' }}>2 Branches</h2>
        </div>
        <div className="stat-card">
          <span style={{ fontSize: '0.85rem', color: 'var(--text-2)' }}>Active Verified Sites</span>
          <h2 style={{ fontSize: '1.6rem', color: '#4ade80', marginTop: '6px' }}>1 Active</h2>
        </div>
        <div className="stat-card">
          <span style={{ fontSize: '0.85rem', color: 'var(--text-2)' }}>Onboarding Under Review</span>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        ...
        <div style={{ background: 'var(--surface)', padding: '24px', borderRadius: '14px', border: '1px solid var(--border)' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-2)', marginBottom: '16px' }}>Inspect pending pharmacy registration applications and compliance documentation.</p>
